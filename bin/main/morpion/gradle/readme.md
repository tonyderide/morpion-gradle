...
etape 3:selection case de la grille.
		...
		tente de transformer le string du scanner entré par l'utilisateur en numerique,
		si reussi passe à l'etape suivante, sinon renvoie une erreur.
...
etape 5:verifier si un joueur a gagnÃ©.
		retourne un booleen pour verifier qu'il y a un gagant et terminé le programme.
...
Dans ma fonction main je crée une instance du morpion, puis je teste si un gagnant pour
